...
export default function SignInPage() {
  return (
    <div
      className="relative min-h-screen overflow-hidden bg-[linear-gradient(135deg,#ffffff_0%,#f4f4f5_45%,#ecfdf3_75%,#f5f3ff_100%)]"
    >
      <DotGridBackground />
      ...
      <div className="relative mx-auto flex min-h-screen max-w-5xl items-start justify-center px-4 pt-12 pb-16">
        <div className="w-full max-w-md">
          ...
          <div className="pop-panel rounded-2xl border border-gray-100 bg-white p-8 shadow-lg shadow-gray-100/80">
            <SignInForm showModeToggle={false} initialMode="login" />

            <div className="mt-6 border-t border-gray-100 pt-6 text-center">
              <p className="text-sm text-gray-500">
                New to the portal? <Link prefetch={false} href="/sign-up" className="font-semibold text-gray-900 transition hover:text-black">Create account</Link>
              </p>
            </div>
          </div>
