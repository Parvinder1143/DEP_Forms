...
export default async function Home() {
  ...
  const effectiveDashboardPath = await getDashboardPathForRole(effectiveRole);
  const queueLinks = await getDashboardQueueLinksForRole(effectiveRole);
