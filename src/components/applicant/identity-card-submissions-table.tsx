...
type IdentityCardSubmissionRow = {
  submissionId: string;
  createdAt: string;
  statusText: string;
};

export function IdentityCardSubmissionsTable({
  submissions,
}: {
  submissions: IdentityCardSubmissionRow[];
}) {
                    ...
                    <div className="space-y-3 rounded-xl border border-gray-200 bg-white p-3">
                      <div className="flex items-center justify-between gap-3">
                        ...
                        <button
                          type="button"
                          onClick={() => {
                            const iframe = document.querySelector(`iframe[title="Identity Card form ${submission.submissionId}"]`) as HTMLIFrameElement;
                      ...
                      <iframe
                        src={`/forms/identity-card/${submission.submissionId}?embed=1`}
                        title={`Identity Card form ${submission.submissionId}`}
