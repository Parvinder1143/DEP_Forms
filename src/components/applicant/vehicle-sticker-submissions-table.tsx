...
type VehicleStickerSubmissionRow = {
  submissionId: string;
  createdAt: string;
  statusText: string;
};

export function VehicleStickerSubmissionsTable({
  submissions,
}: {
  submissions: VehicleStickerSubmissionRow[];
}) {
                    ...
                    <div className="space-y-3 rounded-xl border border-gray-200 bg-white p-3">
                      <div className="flex items-center justify-between gap-3">
                        ...
                        <button
                          type="button"
                          onClick={() => {
                            const iframe = document.querySelector(`iframe[title="Vehicle Sticker form ${submission.submissionId}"]`) as HTMLIFrameElement;
                      ...
                      <iframe
                        src={`/forms/vehicle-sticker/${submission.submissionId}?embed=1`}
                        title={`Vehicle Sticker form ${submission.submissionId}`}
